...
# test_regen_block_shape and test_variant_v006_doc_facts_match_live_registry
# deleted in U6 with regen_program_docs.py — the AUTOGEN block sync mechanism
# is gone (caused bug #115); programs/<lane>-session.md is now the static
# canonical source.
