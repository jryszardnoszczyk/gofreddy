...
- [ ] **Unit 1: Harness micro-cleanups (R-#1, #2, #4, #5, #6)**
...
- [ ] **Unit 2: Autoresearch foundations (R-#12, #25)**
...
- [ ] **Unit 3: Inner-vs-outer correlation telemetry (R-#14)**
...
- [ ] **Unit 4: Replace `inventory.generate` with breadcrumb (R-#3)**
...
- [ ] **Unit 5: Promote `autoresearch/report_base.py` → `src/shared/reporting/` (R-#16)**
...
- [ ] **Unit 6: Co-locate safety primitives → `src/shared/safety/` (R-#18)**
...
- [ ] **Unit 7: SHA256 hash check + subprocess isolation (R-#13, #24)**
...
- [ ] **Unit 8: Close audit plan R5 residuals (R-#7, #8, #9, #11, #22)**
...
**Pre-Phase-6 gate — verify rubric coverage claims.** Several Phase 6 removals predicate on "rubrics already cover this" (Unit 11 length-factor claim: MON-8 + CI-8 rubrics measure proportionality; Unit 12 rework + synth-ratio claim: signals surface to MON-2 / MON-8 rubric context). Before opening Phase 6 PRs, grep the cited rubric files and confirm the claim — if MON-8 doesn't actually score length appropriateness, removing length-factor leaves a real gap. Takes 10 minutes; expensive if skipped.


- [ ] **Unit 9: Pareto-constraint critique agent (R-#15)**
...
- [ ] **Unit 10: Autoresearch agentic replacements (R-#29, #30, #31)**
...
- [ ] **Unit 11: Evaluation judge replacements (R-#32, #33, #34)**
  ...
  - Modify: `src/evaluation/service.py:77-114` + `_WORD_RANGES:30` — delete length-factor entirely. MON-8 + CI-8 rubrics already measure proportionality (**verify before landing** — see Phase 6 preamble gate).
...
- [ ] **Unit 12: Evaluation structural gate removals (R-#35, #36, #37)**
...
- [ ] **Unit 13: Ad-domain agent fallback (R-#38)**
...
- [ ] **Unit 14: Monitor summarizer (R-#39)**
...
- [ ] **Unit 15: Producer-owned evaluation-scope YAML (R-#40)**
