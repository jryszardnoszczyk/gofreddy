...
| X-5 | Structural richness. Bracket-aware: SHARP earns 5 with one sharp claim+support pair; BUILD earns 5 with prose intro + structural pivot + 3-5 substantive bullets + authority anchor + outcome metric; CASE-STUDY earns 5 with multi-paragraph narrative + sensory detail + numbers timeline + implication close. Pad-to-length = ≤4. |
...
| LI-5 | Structural richness + hashtag-count quality. Bracket-aware: SHORT_TAKE (500-900) earns 5 with story-opening + 1 substantive paragraph + closing thought; THOUGHT_LEADER (1500-2500) earns 5 with story → frame → 3-5 numbered points → implication close; CASE_STUDY (2500-3000) earns 5 with multi-paragraph narrative + numbers timeline + named characters + implication close. Pad-to-length, "I'm sharing this because..." filler, motivational-poster generality = ≤4. **Hashtag-count component:** 3-5 targeted hashtags = ideal (no penalty); 1-2 = suboptimal (cap dimension at 7); 0 = ≤4 (zero-tag posts get less LinkedIn distribution). Spam guardrail (count > 5) hard-fails at structural_gate, never reaches this rubric. |
