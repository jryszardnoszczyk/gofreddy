...
### 8c. Comprehensive-deliverable validation gate (added 2026-05-19)

Before v3.5 ships to v006 / workflows: run Components B–F retroactively against the current 4 Phase-3 fixtures (DWF, Anthropic, Perplexity, Klinika). Eyeball whether `structural_gate` checks fire correctly and whether the modular package delivers genuinely more value than Component A alone. If not, the modular architecture is wrong and we revert to standalone Component A. **This is the v3.5 validation gate.**
