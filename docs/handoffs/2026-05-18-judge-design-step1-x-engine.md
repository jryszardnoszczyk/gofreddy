...
status: DRAFT v3 — Option D surgical edits per spot-check audit (substrate-readiness gate, voice.md PRE-REQ specified, wrapper info-leak softened, first-cohort exemption for F/G/H, I3 judge-coverage deferral documented, X-6 promotion threshold reframed, §3 lane-DNA framing). All v2 scope (12-component bundle + 10 per-cycle increments) preserved.
